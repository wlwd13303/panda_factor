...
class PartitionedMarketDataReader:
    ...
    def get_market_data(self, symbols, start_date, end_date, fields=None, batch_size=5000, use_disk_cache=True, parallel=True):
        """
    ...
    def _get_market_data_for_year(self, symbols, start_date, end_date, year, fields, batch_size):
        ...
        if collection_name not in self.db.list_collection_names():
            ...
            if 0 in self._available_years:
                ...
                logger.debug(f"Collection {collection_name} not found and main collection not available, skipping year {year}")
                return None
