...
def load_config(config_path=None):
    ...
    if config_path is None:
        config_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'panda_common', 'config.yaml')
...
def optimize_mongodb(config_path=None, 
    ...
    index_size_diff_percent = (index_size_diff / stats_before['totalIndexSize']) * 100 if stats_before['totalIndexSize'] > 0 else 0
